...
namespace Airlines.XAirlines.Helpers
{
    public class CurrencyHelper
    {
        public static CurrencyInfo GetCurrencyInfo()
        {
            ...
            string backupDataLocation = @".\TestData\CurrencyBackupMockData\";//System.Web.Hosting.HostingEnvironment.MapPath(@"~\TestData\CurrencyBackupMockData\");
            ...
            using (WebClient client = new WebClient())
            {
                ...
                try
                {
                    ...
                    curr = JsonConvert.DeserializeObject<CurrencyInfo>(json); //(new JavaScriptSerializer().Deserialize<CurrencyInfo>(json));
