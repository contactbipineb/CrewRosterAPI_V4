...
namespace Airlines.XAirlines.Helpers
{
    public class WeatherHelper
    {
        public static WeatherInfo GetWeatherInfo(string des)
        {
            ...
            string backupDataLocation = @".\TestData\WeatherBackupMockData\";// Microsoft.Extensions.Hosting.IHostingEnvironment(@"~\TestData\WeatherBackupMockData\");
            ...
            using (WebClient client = new WebClient())
            {
                ...
                try
                {
                    ...
                    weatherinfo = JsonConvert.DeserializeObject<WeatherInfo>(json); //(new JavaScriptSerializer().Deserialize<WeatherInfo>(json));
